    ...
    def prettyPrint(self):
        ...
        while not queue.isEmpty():
            ...
            while not copy.isEmpty():
                ...
                if first_item_in_layer:
                    print((" " * int(spaces_front)) + (dash_left * int(dash_count)) + (node.data) + (dash_right * int(dash_count)))
                    first_item_in_layer = False
                else:
                    print((" " * int(spaces_mid-extra_spaces)) + (dash_left * int(dash_count)) + (node.data) + (dash_right * int(dash_count)))
                # ----------------------------->
